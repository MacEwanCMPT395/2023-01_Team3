...
class TestStudentSchedule(unittest.TestCase):
    ...
    def test_schedule_core_courses(self):
        ...
        courses = [Course("PCOM 0203", 36, 1, 15, 1.5, 0), 
                    Course("SUPR 0751", 36, 1, 7, 1.5, 0), 
                    Course("PRDV 0201", 20, 1, 21, 1.5, 0),
                    Course("PRDV 0202", 20, 1, 14, 1.5, 0),
                    Course("FODDER 101", 40, 1, 40, 3, 0)]
